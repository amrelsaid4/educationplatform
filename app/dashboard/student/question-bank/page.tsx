...
export default function StudentQuestionBankPage() {
  ...
  const loadQuestions = async () => {
    try {
      const teacherIds = enrolledCourses.map(enrollment => enrollment.courses.teacher_id)
  ...
  const loadCategories = async () => {
    try {
      ...
      setCategories(categoriesWithCount.filter(cat => cat.question_count > 0))
    } catch (error) {
      console.error('Error loading categories:', error)
    }
  }
  ...
  const filteredQuestions = questions.filter(question => {
    ...
    return matchesSearch && matchesCategory && matchesDifficulty && matchesType && matchesTeacher
  })
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm text-gray-600 dark:text-gray-400">الأسئلة المتاحة</p>
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm text-gray-600 dark:text-gray-400">المعلمون</p>
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm text-gray-600 dark:text-gray-400">الدورات المسجلة</p>
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                {enrolledCourses.length === 0 
                  ? 'يجب عليك التسجيل في دورات أولاً لرؤية الأسئلة العامة من المعلمين'
                  : searchTerm || selectedCategory !== 'all' || selectedTeacher !== 'all' || selectedDifficulty !== 'all' || selectedType !== 'all'
                    ? 'لا توجد أسئلة تطابق الفلاتر المحددة'
                    : 'لا توجد أسئلة عامة متاحة من معلميك حالياً'
                }
              </p>
              {enrolledCourses.length === 0 && (
                <a
